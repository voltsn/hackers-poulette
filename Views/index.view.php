...
?>
    ...
    <form class="w-11/12 max-w-2xl text-white" id="support-form" action="/" method="post">
        <div class="form-group mb-6">
            ...
            <?php echo isset($validation_result["firstname"]) ? "<p class='bg-red-100 py-2 px-4 mb-4 text-sm text-red-700 rounded mb-3'>$validation_result[firstname]</p>" : "" ?>
        </div>
        <div class="form-group mb-6">
            ...
            <?php echo isset($validation_result["lastname"]) ? "<p class='bg-red-100 py-2 px-4 mb-4 text-sm text-red-700 rounded mb-3'>$validation_result[lastname]</p>" : "" ?>
        </div>
        <div class="form-group mb-6">
            ...
            <?php echo isset($validation_result["email"]) ? "<p class='bg-red-100 py-2 px-4 mb-4 text-sm text-red-700 rounded mb-3'>$validation_result[email]</p>" : "" ?>
        </div>
        <div class="form-group mb-6">
            ...
            <?php echo isset($validation_result["comment"]) ? "<p class='bg-red-100 py-2 px-4 mb-4 text-sm text-red-700 rounded mb-3'>$validation_result[comment]</p>" : "" ?>
        </div>
